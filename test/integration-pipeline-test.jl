...
@testset "End-to-End Integration Pipeline" begin
    ...
    @testset "Complete cleaning + processing workflow" begin
        ...
        # Write test files
        initial_file = test_dir("integration_initial.csv")
        cumulative_file = test_dir("integration_cumulative.csv")
        ...
        initial_cleaned_file = test_dir("clean_integration_initial.csv") 
        cumulative_cleaned_file = test_dir("clean_integration_cumulative.csv")
    ...
    @testset "Error propagation through pipeline" begin
        ...
        bad_file = test_dir("integration_bad_data.csv")
        ...
        bad_clean_file = test_dir("clean_integration_bad_data.csv")
    ...
    @testset "Data consistency validation across pipeline stages" begin
        ...
        test_file = test_dir("integration_consistency_test.csv")
        ...
        if Try.isok(cleaning_result)
            cleaned_file = test_dir("clean_integration_consistency_test.csv")
