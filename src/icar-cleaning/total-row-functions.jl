...
- `reg::Regex`: A positional Regex argument to select columns for totals checking.
- `atol::Float64`: Absolute tolerance for comparing floating point numbers (default: `0.0`).
